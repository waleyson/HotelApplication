...
if(!empty($baseFareInfo))
{
    foreach ($baseFareInfo as $info)
    {
        ...
        $gAddress = $info->gAddress;
        $gPhoneNo = $info->gPhoneNo;
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $guestFName; ?>" class="form-control" id="guestFName" name="guestFName" maxlength="50" placeholder="First Name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="guestLName">Guest Last Name</label>
                                        <input type="text" value="<?php echo $guestLName; ?>" class="form-control" id="guestLName" name="guestLName" maxlength="30" placeholder="Last name">
                                    </div>
                                </div>    
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $gAddress; ?>" class="form-control" id="gAddress" name="gAddress" maxlength="100" placeholder="Address">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="gPhoneNo">Mobile No</label>
                                        <input type="text" value="<?php echo $gPhoneNo; ?>" class="form-control" id="gPhoneNo" name="gPhoneNo" maxlength="10" placeholder="Mobile No">
                                    </div>
                                </div>    
                            </div>
                            <div class="row">
