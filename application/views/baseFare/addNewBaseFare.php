                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php  echo set_value('guestFName') ?>" class="form-control" id="guestFName" name="guestFName" maxlength="50"  placeholder="e.g. Afeez">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="guestLName">Guest Last Name</label>
                                        <input type="text" value="<?php  echo set_value('guestLName') ?>" class="form-control" id="guestLName" name="guestLName" maxlength="50"  placeholder="e.g. Olawale">
                                    </div>
                                </div>    
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php  echo set_value('gAddress') ?>" class="form-control" id="gAddress" name="gAddress" maxlength="100"  placeholder="e.g. No. 14 suite 13 Sabo estate">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="gPhoneNo">Mobile No.</label>
                                        <input type="text" value="<?php  echo set_value('gPhoneNo') ?>" class="form-control" id="gPhoneNo" name="gPhoneNo" maxlength="20"  placeholder="e.g. 0815021190">
                                    </div>
                                </div>    
                            </div>
                            <div class="row">
