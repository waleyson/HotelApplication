...
class BaseFare extends BaseController
{
    ...
    function addNewBaseFare()
    {
            ...
            $this->global['pageTitle'] = 'Fast Track Hotel : Add New Base Fare';
            $this->load->model("rooms_model");
            $data['roomSizes'] = $this->rooms_model->getRoomSizes();
    ...
    function addedNewBaseFare()
    {
            ...
            $this->form_validation->set_rules('guestLName','Guest Last Name','trim|required');
            $this->form_validation->set_rules('gAddress','Guest Address','trim|required');
            $this->form_validation->set_rules('gPhone','Service Tax','trim|required|numeric|xss_clean');
            ...
            {
                $guestFName = $this->input->post('guestFName');
                $guestLName = $this->input->post('guestLName');
                $gAddress = $this->input->post('gAddress');
                $gPhoneNo = $this->input->post('gPhoneNo');
                ...
                $baseFareInfo = array("guestFName"=>$guestFName,"guestLName"=>$guestLName,"gAddress"=>$gAddress,"gPhoneNo"=>$gPhoneNo,"sizeId"=>$roomSizeId, "baseFareHour"=>$baseFareHour,
    ...
    function editOldBaseFare($bfId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Fast Track Hotel : Edit Base Fare';
    ...
    function updateOldBaseFare()
    {
        ...
        else
        {
            ...
            $this->form_validation->set_rules('guestFName','Guest First Name','trim|required');
            $this->form_validation->set_rules('guestLName','Guest Last Name','trim|required');
            $this->form_validation->set_rules('gAddress','Guest Address','trim|required');
            $this->form_validation->set_rules('sizeId','Room Size Id','trim|required');
            $this->form_validation->set_rules('gPhoneNo','Guest Phone','trim|required|numeric|xss_clean');
