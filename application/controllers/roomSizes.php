...
class RoomSizes extends BaseController
{
    ...
    function roomSizesListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Fast Track Hotel : Room Size Listing';
    ...
    function addNewRoomSize()
    {
        ...
        {
            $this->global['pageTitle'] = 'Fast Track Hotel : Add New Room Size';
    ...
    function editOldRoomSize($roomSizeId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Fast Track Hotel : Edit Room Size';
