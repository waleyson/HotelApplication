...
class BaseFare_model extends CI_Model
{
    ...
    {
        $this->db->select(' BaseTbl.guestFName, BaseTbl.guestLName, BaseTbl.gAddress, BaseTbl.gPhoneNo, BaseTbl.gEmail,BaseTbl.bfId, BaseTbl.baseFareHour, BaseTbl.baseFareDay, BaseTbl.serviceTax, BaseTbl.serviceCharge, BaseTbl.fareTotal, BaseTbl.sizeId, RS.sizeTitle, RS.sizeDescription');
    ...
    {
        $this->db->select(" guestFName, guestLName, gAddress, gPhoneNo, gEmail, bfId, baseFareHour, sizeId,baseFareDay, serviceTax, serviceCharge");
