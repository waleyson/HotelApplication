...
$route['bookListing'] = 'booking/bookListing';
$route['baseFareListing/(:num)'] = "booking/bookListing/$1";
$route['addNewBook'] = "booking/addNewBook";
$route['addedNewBook'] = "booking/addedNewBook";
$route['editOldBook'] = "booking/editOldBook";
$route['editOldBook/(:num)'] = "booking/editOldBook/$1";
$route['updateOldBook'] = "booking/updateOldBook";
$route['deleteBook'] = "booking/deleteBook";
